...
class JellyfinSdkRepository @Inject constructor(
    ...
    private var apiClient: ApiClient? = null    private var isInitialized = false
        ...
        return try {
            ...
            jellyfin = Jellyfin(
                JellyfinOptions.Builder()
                    .clientInfo(ClientInfo(name = "JellyfinRyan", version = "1.0.0"))
                    .context(context)
                    .build()
            )
            ...
            Log.e("JellyfinSdkRepository", "Failed to initialize SDK", e)
            isInitialized = false
            false
        }
    }
